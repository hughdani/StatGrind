...
<div class="jumbotron text-center" <?php if ($logged_in == true) { echo "style = 'display:none'";} ?>>
  <p>Log In</p> 
</div>
<div class="jumbotron text-center" <?php if ($logged_in == false) { echo "style = 'display:none'";} ?>>
  <p> <?php if (isset($firstname)){ echo "Welcome back, $firstname!"; }?></p> 
</div>

  
<div class="container" <?php if ($logged_in == true) { echo "style = 'display:none'";} ?>>
...
<div class="container" <?php if ($logged_in == false) { echo "style = 'display:none'";} ?>>
    <br><br>
    ...
    <form action="NewAssignmentPage.php" method="post">
      <input type="hidden" name="user_id" id="user_id" <?php if (isset($userid)){ echo "value='$userid'"; }?>/>
