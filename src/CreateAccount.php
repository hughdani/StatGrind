...
<div class="container">
  <form method="post" action="CreateAccount.php">
      User Name: <input type="text" name="user_name" minlength="4" <?php if (isset($username)){ echo "value='$username'"; }?> required><br>
      ...
      First Name: <input type="text" name="first_name" <?php if (isset($firstname)){ echo "value='$firstname'"; }?> required><br>
      Last Name: <input type="text" name="last_name" <?php if (isset($lastname)){ echo "value='$lastname'"; }?> required><br>
